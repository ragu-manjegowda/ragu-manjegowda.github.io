...
{% include post_picwrap.html pos="fit" src="/images/iotAbstract.jpg" alt="IoT project abstract diagram" %}
...
{% include post_picwrap.html pos="fit" src="/images/iotWifiAnalyzer.jpeg" alt="WiFi analyzer output for the IoT project" %}

{% include post_picwrap.html pos="fit" src="/images/iotRpi3AP.jpeg" alt="Raspberry Pi 3 access point setup for the IoT project" %}
